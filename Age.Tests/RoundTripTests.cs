    ...
    public class RoundTripTests
    {
        ...
        public void X25519_RoundTrip()
        {
            using (var identity = X25519Identity.Generate())
            {
                ...
                var plaintext = EncodingExtended.UTF8.GetBytes("Hello, age!");
        ...
        public void Scrypt_RoundTrip()
        {
            ...
            var plaintext = EncodingExtended.UTF8.GetBytes("Hello, scrypt age!");
        ...
        public void Interop_EncryptWithCSharp_DecryptWithAgeCli()
        {
            ...
            {
                var recipient = identity.Recipient;
                var plaintext = EncodingExtended.UTF8.GetBytes("Hello from C# AgeSharp!");
