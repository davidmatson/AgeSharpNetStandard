...
namespace Age.Tests
{
    public class PluginTests
    {
        ...
        private sealed class TestCallbacks : IPluginCallbacks
        {
            ...
            public List<(string Prompt, bool Secret)> SecretRequests { get; } =
                new List<(string Prompt, bool Secret)>();
            public string SecretResponse { get; set; }
            public List<(string Message, string Yes, string No)> Confirmations { get; } =
                new List<(string Message, string Yes, string No)>();
        ...
        public void PluginConnection_WriteAndRead_EmptyBody()
        {
            ...
            conn.WriteStanza("test-type", new[] { "arg1", "arg2" }, Array.Empty<byte>());
            ...
            Assert.Equal(new[] { "arg1", "arg2" }, result.Value.Args);
        ...
        public void PluginConnection_WriteAndRead_WithBody()
        {
            ...
            var buffer = new StringWriter();
            var conn = new PluginConnection(new StringReader(""), buffer);
            conn.WriteStanza("data", Array.Empty<string>(), body);
        ...
        public void PluginConnection_WriteAndRead_LargeBody()
        {
            ...
            var buffer = new StringWriter();
            var conn = new PluginConnection(new StringReader(""), buffer);
            conn.WriteStanza("big", new[] { "x" }, body);
        ...
        public void PluginRecipient_Wrap_BasicProtocol()
        {
            ...
            mockConn.WriteStanza("recipient-stanza", new[] { "0", "X25519", "ephemeral-key-b64" }, wrappedBody);
            mockConn.WriteStanza("done", Array.Empty<string>(), Array.Empty<byte>());
            ...
            Assert.Equal(new[] { "ephemeral-key-b64" }, result.Args);
            Assert.Equal(wrappedBody, result.Body.ToArray());
        ...
        public void PluginRecipient_Wrap_ErrorStanza_Throws()
        {
            ...
            var pluginOutput = new StringWriter();
            var mockConn = new PluginConnection(new StringReader(""), pluginOutput);
            mockConn.WriteStanza("error", Array.Empty<string>(), System.Text.Encoding.UTF8.GetBytes("something went wrong"));
            var pluginResponse = pluginOutput.ToString();
        ...
        public void PluginRecipient_Wrap_UnknownStanza_RespondsUnsupported()
        {
            ...
            var pluginOutput = new StringWriter();
            var mockConn = new PluginConnection(new StringReader(""), pluginOutput);
            mockConn.WriteStanza("grease", new[] { "abc" }, new byte[] { 0xFF });
            mockConn.WriteStanza("recipient-stanza", new[] { "0", "X25519" }, wrappedBody);
            mockConn.WriteStanza("done", Array.Empty<string>(), Array.Empty<byte>());
            var pluginResponse = pluginOutput.ToString();
        ...
        public void PluginRecipient_Wrap_MsgStanza_CallsDisplayMessage()
        {
            ...
            var pluginOutput = new StringWriter();
            var mockConn = new PluginConnection(new StringReader(""), pluginOutput);
            mockConn.WriteStanza("msg", Array.Empty<string>(), System.Text.Encoding.UTF8.GetBytes("Touch your YubiKey"));
            mockConn.WriteStanza("recipient-stanza", new[] { "0", "X25519" }, new byte[] { 0x01 });
            mockConn.WriteStanza("done", Array.Empty<string>(), Array.Empty<byte>());
            var pluginResponse = pluginOutput.ToString();
        ...
        public void PluginRecipient_Wrap_RequestSecret_CallsCallback()
        {
            ...
            var pluginOutput = new StringWriter();
            var mockConn = new PluginConnection(new StringReader(""), pluginOutput);
            mockConn.WriteStanza("request-secret", Array.Empty<string>(), System.Text.Encoding.UTF8.GetBytes("Enter PIN:"));
            mockConn.WriteStanza("recipient-stanza", new[] { "0", "X25519" }, new byte[] { 0x01 });
            mockConn.WriteStanza("done", Array.Empty<string>(), Array.Empty<byte>());
            var pluginResponse = pluginOutput.ToString();
        ...
        public void PluginIdentity_Unwrap_BasicProtocol()
        {
            ...
            var pluginOutput = new StringWriter();
            var mockConn = new PluginConnection(new StringReader(""), pluginOutput);
            mockConn.WriteStanza("file-key", new[] { "0" }, fileKey);
            mockConn.WriteStanza("done", Array.Empty<string>(), Array.Empty<byte>());
            var pluginResponse = pluginOutput.ToString();

            var stanzas = new List<Stanza>
            {
                new Stanza("X25519", new[]{ "some-arg" }, new byte[] { 0xAA, 0xBB })
            };
        ...
        public void PluginIdentity_Unwrap_MultipleStanzas()
        {
            ...
            var pluginOutput = new StringWriter();
            var mockConn = new PluginConnection(new StringReader(""), pluginOutput);
            mockConn.WriteStanza("file-key", new[] { "1" }, fileKey);
            mockConn.WriteStanza("done", Array.Empty<string>(), Array.Empty<byte>());
            var pluginResponse = pluginOutput.ToString();

            var stanzas = new List<Stanza>
            {
                new Stanza("X25519", new [] { "a1" }, new byte[] { 0x01 }),
                new Stanza("scrypt", new [] { "a2", "18" }, new byte[] { 0x02 }),
            };
        ...
        public void PluginIdentity_Unwrap_NoMatch_ReturnsNull()
        {
            ...
            var stanzas = new List<Stanza> { new Stanza("X25519", Array.Empty<string>(), new byte[] { 0x01 }) };
            var conn = new PluginConnection(new StringReader(pluginResponse), new StringWriter());
            var result = identity.UnwrapWithConnection(conn, stanzas);
        ...
        public void PluginIdentity_Unwrap_InternalError_Throws()
        {
            ...
            var pluginOutput = new StringWriter();
            var mockConn = new PluginConnection(new StringReader(""), pluginOutput);
            mockConn.WriteStanza("error", new[] { "internal" }, System.Text.Encoding.UTF8.GetBytes("plugin crashed"));
            var pluginResponse = pluginOutput.ToString();
        ...
        public void PluginIdentity_Unwrap_IdentityError_ContinuesToDone()
        {
            ...
            var pluginOutput = new StringWriter();
            var mockConn = new PluginConnection(new StringReader(""), pluginOutput);
            mockConn.WriteStanza("error", new[] { "identity" }, System.Text.Encoding.UTF8.GetBytes("wrong key"));
            mockConn.WriteStanza("done", Array.Empty<string>(), Array.Empty<byte>());
            var pluginResponse = pluginOutput.ToString();
        ...
        public void PluginIdentity_Unwrap_UnknownStanza_RespondsUnsupported()
        {
            ...
            var pluginOutput = new StringWriter();
            var mockConn = new PluginConnection(new StringReader(""), pluginOutput);
            mockConn.WriteStanza("grease", Array.Empty<string>(), new byte[] { 0xFF });
            mockConn.WriteStanza("file-key", new[] { "0" }, fileKey);
            mockConn.WriteStanza("done", Array.Empty<string>(), Array.Empty<byte>());
            var pluginResponse = pluginOutput.ToString();
        ...
        public void AgeEncrypt_Decrypt_X25519_StillWorks()
        {
            using (var identity = X25519Identity.Generate())
            {
                var plaintext = EncodingExtended.UTF8.GetBytes("Hello, batch unwrap!");
        ...
        {
            var plaintext = EncodingExtended.UTF8.GetBytes("Hello, scrypt!");
        ...
        public void PluginRecipient_Wrap_ConfirmStanza_CallsCallback()
        {
            ...
            var pluginOutput = new StringWriter();
            var mockConn = new PluginConnection(new StringReader(""), pluginOutput);
            mockConn.WriteStanza("confirm", new[] { "yes-btn", "no-btn" }, System.Text.Encoding.UTF8.GetBytes("Allow access?"));
            mockConn.WriteStanza("recipient-stanza", new[] { "0", "X25519" }, new byte[] { 0x01 });
            mockConn.WriteStanza("done", Array.Empty<string>(), Array.Empty<byte>());
            var pluginResponse = pluginOutput.ToString();
        ...
        public void PluginRecipient_Wrap_ConfirmDenied_SendsFail()
        {
            ...
            var pluginOutput = new StringWriter();
            var mockConn = new PluginConnection(new StringReader(""), pluginOutput);
            mockConn.WriteStanza("confirm", new[] { "yes-btn" }, System.Text.Encoding.UTF8.GetBytes("Allow?"));
            mockConn.WriteStanza("recipient-stanza", new[] { "0", "X25519" }, new byte[] { 0x01 });
            mockConn.WriteStanza("done", Array.Empty<string>(), Array.Empty<byte>());
            var pluginResponse = pluginOutput.ToString();
        ...
        public void PluginRecipient_Wrap_ConfirmNoCallbacks_Throws()
        {
            ...
            var pluginOutput = new StringWriter();
            var mockConn = new PluginConnection(new StringReader(""), pluginOutput);
            mockConn.WriteStanza("confirm", Array.Empty<string>(), System.Text.Encoding.UTF8.GetBytes("Allow?"));
            var pluginResponse = pluginOutput.ToString();
        ...
        public void PluginConnection_WriteAndRead_ExactMultipleOf64Body()
        {
            ...
            var buffer = new StringWriter();
            var conn = new PluginConnection(new StringReader(""), buffer);
            conn.WriteStanza("exact", Array.Empty<string>(), body);
        ...
        public void PluginRecipient_Wrap_RecipientStanzaMissingArgs_Throws()
        {
            ...
            mockConn.WriteStanza("recipient-stanza", new[] { "0" }, new byte[] { 0x01 });
            var pluginResponse = pluginOutput.ToString();
        ...
        public void PluginRecipient_Wrap_MsgWithoutCallbacks_NoThrow()
        {
            ...
            var pluginOutput = new StringWriter();
            var mockConn = new PluginConnection(new StringReader(""), pluginOutput);
            mockConn.WriteStanza("msg", Array.Empty<string>(), System.Text.Encoding.UTF8.GetBytes("info"));
            mockConn.WriteStanza("recipient-stanza", new[] { "0", "X25519" }, new byte[] { 0x01 });
            mockConn.WriteStanza("done", Array.Empty<string>(), Array.Empty<byte>());
            var pluginResponse = pluginOutput.ToString();
        ...
        public void PluginIdentity_Unwrap_RequestSecretNoCallbacks_Throws()
        {
            ...
            var pluginOutput = new StringWriter();
            var mockConn = new PluginConnection(new StringReader(""), pluginOutput);
            mockConn.WriteStanza("request-secret", Array.Empty<string>(), System.Text.Encoding.UTF8.GetBytes("PIN:"));
            var pluginResponse = pluginOutput.ToString();
        ...
        public void PluginIdentity_Unwrap_ConfirmCallsCallback()
        {
            ...
            var pluginOutput = new StringWriter();
            var mockConn = new PluginConnection(new StringReader(""), pluginOutput);
            mockConn.WriteStanza("confirm", new[] { "yes-btn", "no-btn" }, System.Text.Encoding.UTF8.GetBytes("Allow?"));
            mockConn.WriteStanza("file-key", new[] { "0" }, fileKey);
            mockConn.WriteStanza("done", Array.Empty<string>(), Array.Empty<byte>());
            var pluginResponse = pluginOutput.ToString();
        ...
        public void PluginIdentity_Unwrap_FileKeyMissingIndex_Throws()
        {
            ...
            var pluginOutput = new StringWriter();
            var mockConn = new PluginConnection(new StringReader(""), pluginOutput);
            mockConn.WriteStanza("file-key", Array.Empty<string>(), new byte[16]);
            var pluginResponse = pluginOutput.ToString();
