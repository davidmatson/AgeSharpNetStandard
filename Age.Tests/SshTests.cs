...
namespace Age.Tests
{
    public class Ed25519ConverterTests
    {
        ...
        public void PrivateKeyToX25519_IsSha512FirstHalf()
        {
            ...
            var sha512 = SHA512Extended.HashData(seed);
            Assert.Equal(sha512.AsSpan().Slice(0, 32).ToArray(), x25519Priv);
        }
    ...
    public class SshKeyParserTests
    {
        ...
        public void ParsePrivateKey_Pkcs8Rsa()
        {
            ...
            var (keyType, _, privKey) = SshKeyParser.ParsePrivateKey(pkcs8Pem);
            Assert.Equal("ssh-rsa", keyType);
            Assert.IsType<RsaPrivateCrtKeyParameters>(privKey);
        }
    ...
    public class SshEd25519RecipientIdentityTests
    {
        ...
        {
            var seed = new byte[32];
            RandomNumberGeneratorExtended.Fill(seed);
            var priv = new Ed25519PrivateKeyParameters(seed);
            var pub = priv.GeneratePublicKey();
        ...
        public void Unwrap_WrongStanzaType_ReturnsNull()
        {
            ...
            using (var identity = SshEd25519Identity.Parse(pemText))
            {
                var stanza = new Age.Format.Stanza("X25519", new[] { "arg" }, new byte[32]);
        ...
        public void Unwrap_WrongArgCount_Throws()
        {
            ...
            using (var identity = SshEd25519Identity.Parse(pemText))
            {
                var stanza = new Age.Format.Stanza("ssh-ed25519", new[] { "onlyone" }, new byte[32]);
        ...
        public void Unwrap_InvalidEphKeyEncoding_Throws()
        {
            ...
            using (var identity = SshEd25519Identity.Parse(pemText))
            {
                ...
                var stanza = new Age.Format.Stanza("ssh-ed25519", new[] { goodStanza.Args[0], "@@invalid@@" }, goodStanza.Body.ToArray());
                Assert.Throws<AgeHeaderException>(() => identity.Unwrap(stanza));
            }
        }
        ...
        public void Unwrap_WrongEphKeyLength_Throws()
        {
            ...
            using (var identity = SshEd25519Identity.Parse(pemText))
            {
                ...
                var stanza = new Age.Format.Stanza("ssh-ed25519", new[] { goodStanza.Args[0], shortKeyB64 }, goodStanza.Body.ToArray());
                Assert.Throws<AgeHeaderException>(() => identity.Unwrap(stanza));
            }
        }
        ...
        public void Unwrap_WrongBodyLength_Throws()
        {
            ...
            using (var identity = SshEd25519Identity.Parse(pemText))
            {
                ...
                var stanza = new Age.Format.Stanza("ssh-ed25519", goodStanza.Args.ToArray(), new byte[16]);
                Assert.Throws<AgeHeaderException>(() => identity.Unwrap(stanza));
            }
        }
    }
    ...
    public class SshRsaRecipientIdentityTests
    {
        ...
        public void Unwrap_WrongArgCount_Throws()
        {
            ...
            using (var identity = SshRsaIdentity.Parse(pemText))
            {
                var stanza = new Age.Format.Stanza("ssh-rsa", new[] { "tag", "extra" }, new byte[256]);
                Assert.Throws<AgeHeaderException>(() => identity.Unwrap(stanza));
            }
        }
        ...
        public void Unwrap_CorruptBody_ReturnsNull()
        {
            ...
            using (var identity = SshRsaIdentity.Parse(pemText))
            {
                ...
                var corruptStanza = new Age.Format.Stanza("ssh-rsa", stanza.Args.ToArray(), corruptBody);
        ...
        public void Unwrap_OversizedBody_ReturnsNull()
        {
            ...
            using (var identity = SshRsaIdentity.Parse(pemText))
            {
                ...
                RandomNumberGeneratorExtended.Fill(oversizedBody);
                var oversizedStanza = new Age.Format.Stanza("ssh-rsa", stanza.Args.ToArray(), oversizedBody);
    ...
    public class SshRoundTripTests
    {
        ...
        public void SshEd25519_FullEncryptDecrypt()
        {
            ...
            using (var identity = SshEd25519Identity.Parse(pemText))
            {
                var plaintext = EncodingExtended.UTF8.GetBytes("Hello, SSH Ed25519!");
        ...
        public void SshRsa_FullEncryptDecrypt()
        {
            ...
            using (var identity = SshRsaIdentity.Parse(pemText))
            {
                var plaintext = EncodingExtended.UTF8.GetBytes("Hello, SSH RSA!");
        ...
        public void SshMixed_X25519AndSshRecipients()
        {
            ...
            using (var x25519Identity = X25519Identity.Generate())
            {
                ...
                {
                    var plaintext = EncodingExtended.UTF8.GetBytes("Multi-recipient test");
        ...
        public void Interop_SshEd25519_EncryptWithCSharp_DecryptWithAgeCli()
        {
            ...
            try
            {
                ...
                using (var keygenProc = Process.Start(keygenPsi))
                {
                    ...
                    var plaintext = EncodingExtended.UTF8.GetBytes("Hello from C# SSH Ed25519!");
        ...
        public void Interop_SshRsa_EncryptWithCSharp_DecryptWithAgeCli()
        {
            ...
            try
            {
                ...
                using (var keygenProc = Process.Start(keygenPsi))
                {
                    ...
                    var plaintext = EncodingExtended.UTF8.GetBytes("Hello from C# SSH RSA!");
