    ...
    internal static class CryptoHelper
    {
                                          ...
                                          ReadOnlySpan<byte> plaintext, Span<byte> ciphertextWithTag)
        {
            cipher.Encrypt(nonce, plaintext,
                ciphertextWithTag.Slice(0, plaintext.Length),
                                          ...
                                          ReadOnlySpan<byte> ciphertextWithTag, Span<byte> plaintext)
        {
            ...
            try
            {
                cipher.Decrypt(nonce,
                    ciphertextWithTag.Slice(0, plaintextLen),
                    ciphertextWithTag.Slice(plaintextLen),
                    plaintext.Slice(0, plaintextLen));
            }
        ...
        public static byte[] HmacSha256(ReadOnlySpan<byte> key, ReadOnlySpan<byte> data)
        {
            ...
            HMACSHA256Extended.HashData(key, data, result);
            return result;
        }
    }
}
